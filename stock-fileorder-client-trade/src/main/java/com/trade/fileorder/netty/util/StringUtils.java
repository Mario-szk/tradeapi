...
public abstract class StringUtils {
	 ...
	 * @see java.lang.Character#isWhitespace
	 */
	public static boolean isBlankN(CharSequence cs) {
		int len;
	...
	public static boolean isBlank(String... strs) {
		...
		for (String str : strs) {
			if (str == null || "".equals(str.trim()) || "null".equals(str.trim())
					|| "".equals(str.trim()) || "undefined".equals(str.trim()) || "(null)".equals(str.trim())) {
				return true;
			}
		}
		return false;
     ...
     * and then the return will be 1,222,222.22 . 
     * It depends on NumberFormat.getInstance() .
     * @param value
     * @return
     */
	...
	/**    
	 * @Description:获取动态的话题名
	 * @param str
	 * @return  
	 */
	public static List<String> findTopicList(String str){
	...
	/*public static void main(String[] args){
		String str="@dezysdf弄 电饭锅电饭锅@电饭锅电 饭锅大范甘迪发";
		for (String str1:findAitList(str)) {
