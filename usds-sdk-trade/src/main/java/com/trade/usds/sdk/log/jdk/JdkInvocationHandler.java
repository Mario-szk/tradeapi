package com.trade.usds.sdk.log.jdk;
...
public class JdkInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
       // StackTraceElement[] stacktrace = ((Thread)proxy).getStackTrace();
    ...
    private FileAppender<ILoggingEvent> getAppender(Logger logger, Method method) {
